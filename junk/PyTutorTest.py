...
def parse(s):
    ...
    master_d = {'instructions': 'noun', 'holding': 'verb', 'can': 'conditional',  "we're": 'pronoun', 'heavy': 'adjective', 'multiple': 'adjective', '3': 'adjective', 'enroute': 'adjective', 'still': 'adjective', 'front': 'adjective', 'start': 'adjective', '18': 'adjective', '.9': 'adjective', 'no': 'adjective', 'this': 'adjective', 'asap': 'adverb', 'back': 'adverb', 'east': 'adverb', 'now': 'adverb', 'then': 'adverb', 'west': 'adverb', 'soon': 'adverb', 'in': 'preposition', 'to': 'preposition', 'between': 'preposition', 'on': 'preposition', 'with': 'preposition', 'of': 'preposition', 'as': 'preposition', 'for': 'preposition', 'and': 'conjunction', 'the': 'article', 'S3/4': 'noun', 'CP3': 'noun', 'Cp9': 'noun', 'CP8': 'noun', 'ugv1': 'noun', '75m': 'noun', 'cp17': 'noun', 'ugv2': 'noun', 'cp30': 'noun', 'you': 'pronoun', 'confirm': 'verb', 'uav':'noun', 'mission': 'noun'}

    let_num = ['S3/4', 'CP3', 'Cp9', 'CP8', 'ugv1', '75m', 'cp17', 'ugv2', 'cp30']
    
    id_t = s[0]
    print(f"is this id_t a set? {id_t}")
    mult_sent = []
    ind_sent = []
    lst_sent = []
    if ',' in s[1]:
...
print(parse(['88201f43-a1e0-49f4-81cd-fbb59f4b601a', 'can you confirm, uav mission']))
